...
class NoImageProgressCardCell: NoImageCardCell, ProgressPanel {
    class override var identifier: String {
        return "NoImageProgressCardCell"
    }
    ...
    override func configure(_ post: Post?) {
        ...
        configureMeterContainer(post: post, topView: descContainer)
    }
