...
//import CryptoKit
//
//class ChatViewController: ParentListViewController<Message>, ImageUploadable {
...
//        cell.myId = userId
//        let message = postArr[indexPath.row]
//        cell.updateAppearanceFor(.pending(message))
//        
//        // if the last message and the keyboard overlaps, transform the message higher
...
//                self?.postArr = documents.map { docSnapshot -> Message in
...
//                    
//                    return Message(id: docId, content: content, displayName: displayName, sentAt: formattedDate, imageURL: imageURL)
//                }
//            }
//    }
//    
