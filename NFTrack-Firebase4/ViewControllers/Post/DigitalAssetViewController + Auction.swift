...
//        let mintParameters = MintParameters(price: nil, itemTitle: "Test", desc: "Test", category: "Electronics", convertedId: "1000", tokensArr: [], userId: "343fdf", deliveryMethod: "online", saleFormat: "Auction", paymentMethod: "Auction", contractFormat: "Auction", postType: "Digital", saleConfigValue: .digitalNewSaleAuctionBeneficiaryIntegral)
...
//        let biddingTime = numOfDays.intValue * 60 * 60 * 24
    ...
    func newIntegralAuction(
        mintParameters: ParentPostViewController.MintParameters,
        biddingTime: Int,
        startingBid: NSNumber
    ) {
